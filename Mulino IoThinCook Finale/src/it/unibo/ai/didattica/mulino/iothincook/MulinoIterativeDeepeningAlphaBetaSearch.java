...
public class MulinoIterativeDeepeningAlphaBetaSearch extends
	...
	public MulinoIterativeDeepeningAlphaBetaSearch(
		...
		if(game.getInitialState().getCurrentPhase()==Phase.FIRST){
			super.setMaxDepth(7);
			super.setInitialDepth(5);
		}else if(game.getInitialState().getCurrentPhase()==Phase.SECOND){
			super.setMaxDepth(9);
			super.setInitialDepth(7);
		}else if(game.getInitialState().getCurrentPhase()==Phase.FINAL){
			super.setMaxDepth(7);
			super.setInitialDepth(5);
		}else{
			super.setMaxDepth(8);
