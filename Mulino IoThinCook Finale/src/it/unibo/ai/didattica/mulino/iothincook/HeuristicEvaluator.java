...
//			result=18*closedMorris()+26*numberOfMorris()+numberOfBlockedOpponentPieces()+9*numberOfPieces()+10*numberOf2PieceConfigurations()+7*numberOf3PieceConfigurations();
			result=30*numberOfMorris()+numberOfBlockedOpponentPieces()+9*numberOfPieces()+20*numberOf2PieceConfigurations()+7*numberOf3PieceConfigurations()+20*blockMill();
			break;
...
//			result=16*closedMorris()+10*numberOf2PieceConfigurations()+numberOf3PieceConfigurations()+1190*winningConfiguration();
			result=30*numberOfMorris()+10*numberOf2PieceConfigurations()+numberOf3PieceConfigurations()+1190*winningConfiguration();
			break;
		}
		return result;
	}
...
//					} 
						try {
							if( cantMoveConfiguration(Checker.BLACK)) 
								return 1; 
							else if ( cantMoveConfiguration(Checker.WHITE)) 
								return -1; 
...
//					} 
						try {
							if( cantMoveConfiguration(Checker.WHITE)) 
								return -1; 
							else if ( cantMoveConfiguration(Checker.BLACK)) 
								return 1; 
							else if(whiteCheckersOnBoard>3 && blackCheckersOnBoard<=3)
								return -0.25;
							else if(whiteCheckersOnBoard<=3 && blackCheckersOnBoard>3)
