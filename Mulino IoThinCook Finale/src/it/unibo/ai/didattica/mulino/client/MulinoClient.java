			...
			while (currentState.getCurrentPhase()==Phase.FIRST) {
				...
				if(whiteIA){
					try{
						...
						IterativeDeepeningAlphaBetaSearch<MulinoState, String, State.Checker> search=new MulinoIterativeDeepeningAlphaBetaSearch(new MulinoGameAllPhases(mulinoCurrentState), -1100, 1100, time);
